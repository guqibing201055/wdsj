...
local function OpenPlayerTeleportWindow()
    ...
    miniBtn.BackgroundColor3 = Config.BtnPurple
    miniBtn.Text = "玩家"
    miniBtn.TextColor3 = Config.TextWhite
    miniBtn.Visible = false
    miniBtn.Parent = sg
    MakeFrameDraggable(miniBtn, miniBtn)
    ...
    local function Refresh()
        ...
        for _,p in pairs(Players:GetPlayers()) do
            ...
            name.Position = UDim2.new(0,3,0,75)
            name.BackgroundTransparency = 1
            name.Text = p.Name
            name.TextColor3 = Config.TextWhite
            name.TextSize = 12
            ...
            btn1.Size = UDim2.new(0.3,0,0,25)
            btn1.Position = UDim2.new(0.02,0,0,95)
            ...
            btn2.Size = UDim2.new(0.3,0,0,25)
            btn2.Position = UDim2.new(0.35,0,0,95)
            ...
            btn3.Size = UDim2.new(0.3,0,0,25)
            btn3.Position = UDim2.new(0.68,0,0,95)
