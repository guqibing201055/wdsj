...
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("空云脚本V3")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
local main = window:Tab("主要的", "17493876383")--1
local main9178 = window:Tab("黑客入侵无需后门", "17493876383")--1
...
local buildashie = window:Tab("鱼", "6031097229")--5
local buildashic = window:Tab("把火车开到终点", "6031097229")--5
...
local teleporte = main9178:section("️合集", false)
...
local CNA = CNScript:section("空云制作", false)
local CNS = CNScript:section("其他国外脚本", false)
local CN = CNScript:section("其他国内脚本", false)
local AQ = CNScript:section("收费国内脚本破解", false)
...
local LOlTab999 = buildashie:section("脚本", true)
local LOlTab998 = buildashic:section("生成火车", true)
local LOlTab997 = buildashic:section("崩服", true)
...
LOL:Label("空云脚本的创作者空云 QQ3126295205")
LOL:Label("空云脚本1群号942272935")
LOL:Button(
    "复制到空云脚本①群号",
    function()
...
teleporte:Button("极品",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/xiaoSB33/M416/refs/heads/main/Wind/sb/c00kidd+1x1x1.LUA", true))()
end)
...
CNA:Label("不知道哪个脚本，请联系QQ3126295205")
CNS:Button(
    "脚本中心",
    function()
...
CN:Button("呱鸡脚本（空云已经帮修复）", function()
      loadstring(game:HttpGet("https://pastebin.com/raw/MRgmQkUy", true))()
end)
CN:Button("空云脚本V2", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/xiaoSB33/M416/refs/heads/main/Wind/sb/空云脚本V2.LUA",true))()
end)
...
AQ:Label("有没有收费其他脚本，请加空云QQ316295205")
AQ:Button(
    "剑客破解版（Xi团队破解）",
    function()
...
LOlTab999:Button("空云制作",function()
loadstring(game:HttpGet("https://github.com/xiaoSB33/M416/raw/main/Wind/sb/鱼.lua", true))()
end)




LOlTab998:Button("生成Expreso火车",function()
game:GetService("ReplicatedStorage").SpawnTrenExpreso:FireServer()
end)
LOlTab998:Button("生成例车",function()
game:GetService("ReplicatedStorage").SpawnTrenAve:FireServer()
end)
LOlTab998:Button("生成四节火车",function()
game:GetService("ReplicatedStorage").SpawnTrenUnderground:FireServer()
end)
LOlTab998:Button("生成运货火车",function()
game:GetService("ReplicatedStorage").SpawnTrenContainer:FireServer()
end)
LOlTab998:Button("生成手推车",function()
game:GetService("ReplicatedStorage").SpawnTrenPalanca:FireServer()
end)
LOlTab997:Button("无限循环(不卡死)",function()
while true do
game:GetService("ReplicatedStorage").SpawnTrenUnderground:FireServer()
task.wait()
end
end)
LOlTab997:Button("(卡死)",function()
...
local tab1 = library:CreateTab("  空云脚本", true)
...
JABAJA:Toggle("空云脚本","text",false,function(s)
...
-- 添加其他功能函数
Jan:Button("空云脚本",function()
--[[
    空云脚本 THIEF LIFE SIMULATOR SOURCE
...
print("[ 空云脚本 ]: 空云脚本 THIEF LIFE SIMULATOR LOADING...")
...
Game:addToggle("RTX着色器", false, function(rtxshaders)
    ...
    if rtxshaders == false then
        for i,v in pairs(game.Lighting:GetChildren()) do
            if v.Name == "[ 空云脚本 ]: 日落" then
                v:Destroy()
            elseif v.Name == "[ 空云脚本 ]: 花" then
                v:Destroy()
            elseif v.Name == "[ 空云脚本 ]: 伊那里泰莎" then
                v:Destroy()
            elseif v.Name == "[ 空云脚本 ]: 简单" then
                v:Destroy()
            elseif v.Name == "[ 空云脚本 ]: 阳光" then
                v:Destroy()
            elseif v.Name == "[ 空云脚本 ]: 高山" then
                v:Destroy()
            end
        end
        wait()
    ...
    while killpetloop do
        if playertarget == "All" then
            ...
            if game.workspace.Pets:FindFirstChild(playertarget .."_PET") ~= nil then
                ...
                Notification:Notify(
                    {Title = "空云脚本", Description = "玩家没有装备宠物"},
                    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "default"}
                )
                killpetloop = false
            end
...
JB_NOTIFICATIONS.new({
	Text = "空云脚本已成功启动，尽情享受吧！",
	Duration = 2
})
end)
Java:Label("↑是不是BUG，有找空云")
...
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("空云脚本 V2.1.2")
----------------------------------------------------------------------------------------------------------------------------------------
